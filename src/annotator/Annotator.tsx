...
import {Form, Row, Col, Container, Button, Card, ListGroup, FormControl} from 'react-bootstrap-v5';

// Annotation content components
import DefinedTermSetEditor from './DefinedTermSetEditor';
...
class Annotator extends Component<AnnotatorProps, AnnotatorState> {
  ...
  constructor(props:AnnotatorProps){
    ...
    this.state = {
      data:{},
      annotations: []
      // annotations: fakeAnnotations as W3CAnnotation[]
    };
  }
...
//     e.preventDefault();
//     const {selectedAnnotationId,start,end,data} = this.state
//     if(!selectedAnnotationId){
//       console.error("No annotation selected to save");
//       return;
//     }
//     // const formattedBody = formatBodyForSolid(data);
...
//       return;
//     }
//     (annotation.body as TextualBody).value = event.target.value
...
//                           </Form.Label>
//                           <Col sm="8">
//                             <Form.Control plaintext readOnly defaultValue={selectedAnnotationId} />
//                           </Col>
//                         </Form.Group>
