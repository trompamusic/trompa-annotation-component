...
export default function KitchenSink(){
	...
	const noop = ()=>{};
	const definedTermSetDefaults = {additionalType:"", creator: "", identifier: "", type: "DefinedTerm" as "DefinedTerm" };
		...
		<Row className='mt-4'>
			<Col md="6" className='mb-4'>
				<Card>
					...
					<Card.Body>
						<Row>
							<TextArea content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vulputate, neque sed ultricies hendrerit, mauris orci porttitor turpis, vitae pharetra ex nunc ut arcu. Maecenas condimentum vulputate ex, nec auctor nunc fermentum a. Pellentesque lorem erat, congue id dignissim id, hendrerit in metus."
