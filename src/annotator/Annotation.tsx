...
export default class Annotation {
	...
	customMotivation?: AnnotationCustomMotivation;
	...
	constructor(identifier:string, target:AnnotationTarget, creator?:string, created?:string,
				motivation?:DefaultAnnotationMotivation, customMotivation?:AnnotationCustomMotivation,
				body?:AnnotationBody)
	{
	...
	get timeString():string | null {
		if (typeof this.target === "string") {
			...
			if (this.target.start !== this.target.end) {
	...
	static fragmentToStartAndEnd(fragment: string): [number, number?] {
		const params = /t=(\d+)(?:,(\d+))?/.exec(fragment)
	...
	static fromCE(ceannotation: any):Annotation {
		...
		let customMotivation: AnnotationCustomMotivation;
